...
$sql=  "SELECT COUNT(*) AS count 
        FROM student s 
        left join name n on s.name_id = n.id
        left join fam f on s.fam_id = f.id 
        left join otch o on s.otch_id = o.id
        eft join date_r d on s.date_r_id = d.id
        eft join tel t on s.tel_id = t.id
